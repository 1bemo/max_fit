...
import 'package:max_fit/components/drill/drillRemoveAlert.dart';
import 'package:max_fit/components/drill/drill.dart';
...
class AddWorkoutDay extends StatefulWidget {
  ...
  const AddWorkoutDay({Key? key, this.day}) : super(key: key);
...
class _AddWorkoutDayState extends State<AddWorkoutDay> {
  ...
  void initState() {
    ...
    if (day.drillBlocks == null || day.drillBlocks!.isEmpty) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('MaxFit // Create Day Plan'),
        actions: <Widget>[
